...
<h2 class="titulo">
    <?php
    echo utf8_encode("Listagem de clientes");
    ?>
</h2>                
...
<a class="shadow" href="alteracao.php?codigo=<?php echo $linha["id_cliente"] ?>">Alterar</a>
<br>

<input class="input_01" disabled="" type="text"  value="Endereco :">
<input class="input_02" disabled="" type="text" 
